...
DHSREGCO = The integer region code associated with the Development Regions. This variable will match a country specific region variable in the DHS recode file.

DHSREGNA = The name associated with the Development Regions.  This variable will match a country specific region variable in the DHS recode file.

ZONECO = The integer region code associated with the Ecological Zones. This variable will match a country specific region variable in the DHS recode file. 

ZONENA = The name associated with the Ecological Zones.  This variable will match a country specific region variable in the DHS recode file.
