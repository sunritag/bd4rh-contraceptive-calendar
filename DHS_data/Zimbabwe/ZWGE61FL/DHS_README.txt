...
DHSREGCO = The integer region code associated with the DHS region created for sampling. This variable will match v024 in the DHS recode file.
*NOTE:  In older templates, REPAR1DHS was used. This field has been renamed DHSREGCO. The REPAR1DHS field is no longer used. 

DHSREGNA = The name associated with the DHS region created for sampling.  This variable will match v024 in the DHS recode file.
